    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('gender', models.CharField(blank=True, choices=[('male', 'Nam'), ('female', 'Nữ'), ('other', 'Khác')], max_length=6, null=True, verbose_name='Giới tính')),
                ('birthday', models.DateField(blank=True, null=True, verbose_name='Ngày sinh')),
                ('bio', models.TextField(blank=True, max_length=100)),
                ('avatar', models.ImageField(default='default/noimage.jpg', upload_to='images/avatars/')),
