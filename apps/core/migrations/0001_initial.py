    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('pending', 'Đang chờ'), ('preparing', 'Đang chuẩn bị'), ('shipped', 'Đã vận chuyển'), ('delivered', 'Đã nhận'), ('cannceled', 'Đã huỷ đơn')], default='pending', max_length=9, verbose_name='Trạng thái')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('description', models.TextField(max_length=255, verbose_name='Bình luận')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('quantity', models.PositiveIntegerField(verbose_name='Số lượng')),
                ('order', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='items', to='core.order', verbose_name='Đơn Hàng')),
                ('shoe_option_size', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='items', to='core.shoeoptionsize', verbose_name='Kích cỡ')),
